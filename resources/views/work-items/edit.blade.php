        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <form method="POST" action="{{ route('work-items.update', $workItem) }}" class="space-y-6">
                        @csrf
                        @method('PUT') <div>
                        ...
                        <div>
                            ...
                            <select name="ahs_items[]" id="select-ahs" multiple 
                                ...
                                @foreach ($allAHS as $ahs)
                                    <option value="{{ $ahs->id }}" 
                                        {{ in_array($ahs->id, old('ahs_items', $selectedAHS)) ? 'selected' : '' }}>
                ...
                new TomSelect('#select-ahs',{
                    ...
                    render: {
                        option: function(data, escape) {
                            ...
                            return `<div><span class="font-semibold">${code}</span><span class="text-gray-600"> - ${rest}</span></div>`;
                        },
