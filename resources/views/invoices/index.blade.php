                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @forelse ($invoices as $invoice)
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">{{ \Carbon\Carbon::parse($invoice->issued_date)->format('m/d/Y') }}</td>
                                    <td class="px-6 py-4 whitespace-nowrap">{{ number_format($invoice->total_amount, 0, ',', '.') }}</td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                            ...
                            @empty
                                <tr>
                                    <td colspan="7" class="px-6 py-4 whitespace-nowrap text-center text-gray-500">
                                        No invoices found. Create one from an approved Billing request.
                                    </td>
                                </tr>
                            @endforelse
                        </tbody>
