        ...
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    @endif
                    @if(session('error'))
                        {{-- Use {!! !!} to render the <br> tags for error messages --}}
                    ...
                    <div class="mb-4 p-4 bg-blue-50 border border-blue-200 rounded-md">
                        ...
                        <ul class="list-disc list-inside text-sm text-blue-700 mt-2">
                            ...
                            <li>The **Export** file from the main page is a perfect template.</li>
                            <li>`item_name`, `category_name`, and `uom` are required.</li>
                            <li>`category_name` must exactly match an existing category.</li>
                            <li>If `item_code` is provided, the system will update that item.</li>
                            <li>If `item_code` is left blank, a new item will be created with an auto-generated code.</li>
                        </ul>
                    </div>
