                    ...
                    <table class="min-w-full">
                        ...
                        <tbody class="bg-white divide-y divide-gray-100">
                            @forelse ($quotations as $quotation)
                                <tr onclick="window.location='{{ route('quotations.show', $quotation) }}'" class="cursor-pointer hover:bg-gray-50/60 transition">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium flex justify-end gap-3">
                                        ...
                                        @if ($quotation->status == 'draft')
                                            <a href="{{ route('quotations.edit', $quotation) }}" onclick="event.stopPropagation()" class="text-gray-400 hover:text-blue-600 transition" title="Edit">
                                            ...
                                            <button type="button" 
                                                    @click.stop="itemToDeleteId = {{ $quotation->id }}; $dispatch('open-modal', 'confirm-quotation-deletion')"
